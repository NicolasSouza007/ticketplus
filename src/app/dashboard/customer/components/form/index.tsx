...
const schema = z.object({
  ...
  phone: z.string().refine(
    ...
    {
      message: "o campo telefone deve conter (DD) 9 9999-9999",
    },
  ),
  address: z.string(),
});
  ...
  return (
    ...
    >
      ...
      <Input
        ...
        register={register}
      />
      <section className="flex gap-2 mt-4 my-4 flex-col sm:flex-row">
      ...
      <label className="mb-1 text-lg font-medium   ">Endereço do Cliente</label>
      <Input
        type="text"
        name="address"
